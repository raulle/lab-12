...
public class RiversController {
    ...
    @FXML
    void doMisure(ActionEvent event) {
    	
    	River r= boxRiver.getValue();
    	Statistics s= model.getMisureFiume(r);
    	txtStartDate.setText(s.getPrimaData().toString());
    	txtEndDate.setText(s.getUltimaData().toString());
    	txtNumMeasurements.setText(s.getNumMis().toString());
    	txtFMed.setText(s.getAvg().toString());
    }
